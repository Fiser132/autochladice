    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isExpanded && (
        <div className="mb-4 space-y-3">
          ...
          {/* WhatsApp Button */}
          <a
            href="https://wa.me/421905262430?text=Zaujímam sa o vaše služby opravy chladičov"
            target="_blank"
      ...
      <button
        ...
        className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
        title="Kontakt"
      >
        {isExpanded ? (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">

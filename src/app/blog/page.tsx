...
export default function Blog() {
  ...
  // Konvertujeme articles objekt na pole pre zobrazenie
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Zistite viac o našich službách opravy autochladičov, spájkovania hliníka a spájkovania hliníka v Bratislave
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            {articlesList.map((article) => (
              <Link 
                ...
                className="group bg-slate-800 rounded-2xl p-8 shadow-xl border border-slate-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
                {/* Article Image */}
                <div className="relative w-full h-48 mb-6 rounded-xl overflow-hidden bg-gradient-to-br from-emerald-600 to-emerald-700">
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <span className="text-gray-400 text-sm">{new Date(article.date).toLocaleDateString('sk-SK')}</span>
                </div>
      ...
      <section className="py-24 bg-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Kontaktujte nás pre bezplatnú konzultáciu a cenovú ponuku vašich služieb
          </p>
